...
class HandTrajectorySequenceDataset(TrajectoryDataset):
    """
    ...
    def __init__(self, data_directory, cache_data_size=1e6):
        ...
        for f in glob(str(data_directory / "**/*.h5"), recursive=True):
...
class hand_train_val_test:
    def __init__(self,          
        ...
        self.sequence_dataset = HandTrajectorySequenceDataset(data_directory)
